    ...
    <div className="bg-base-200 py-16 ps-20">
      <div className="backgroundImg max-w-7xl mx-auto    ">
        <div className="hero min-h-full py-12 rounded-none ">
          <div className="  ">
            <h1
              className="text-center text-4xl font-semibold mt-2 italic text-[#168aad] uppercase underline
         "
            >
              Login Now
            </h1>
       ...
       <button className="absolute right-6 text-xl top-10 bottom-0 flex items-center " onClick={handleShowPass}>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2  shadow-sm justify-center text-xl  w-full py-3 rounded-lg px-10  mt-2  text-black  border "
                    >
